      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            hintText: 'Search by name or email (leave empty to see all users)...',
          ...
          Expanded(
            child: searchUsersAsync.when(
              data: (users) {
                print('Users found: ${users.length}'); // Debug print
                    ...
                    return const Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8),
                          Text(
                            'Try creating an account first, or ask someone to register',
