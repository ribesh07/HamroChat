...
import 'package:hamrochat/screens/auth/auth_wrapper.dart';
import 'package:hamrochat/screens/splash_screen.dart';
...
class _ChatAppState extends State<ChatApp> {
  ...
  ThemeData _buildTheme() {
    // Beautiful color scheme for HamroChat
    const primaryColor = Color(0xFF6C5CE7); // Purple
    const secondaryColor = Color(0xFF00CEC9); // Teal
